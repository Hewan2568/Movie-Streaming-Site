...
/* For smaller screens, hide the navigation links and show the hamburger button */
...
/* For larger screens, show the navigation links and hide the hamburger button */
